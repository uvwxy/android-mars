 ...
 * Hash coordinates of the eight cube corners and add blended results from the eight corners of the cube.<br>
 * Return the sum.<br>
 * 
...
public final class ImprovedPerlin {
	...
	static public double noise(double x, double y, double z) {
		...
		v = fade(y),
		w = fade(z);
		int A = p[X] + Y, AA = p[A] + Z, AB = p[A + 1] + Z, // HASH COORDINATES OF THE 8 CUBE CORNERS,
